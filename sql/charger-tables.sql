INSERT INTO `pays`(`pays_id`, `nom`) VALUES ('1','Canada')

INSERT INTO `statut_utilisateur`(`statut_id`, `titre`) VALUES ('1','administrateur');
INSERT INTO `statut_utilisateur`(`statut_id`, `titre`) VALUES ('2','client');
...
INSERT INTO `centrage`(`centrage_id`, `nom`) VALUES
('1','non spécifié'),
('2','superbe'),
('3','xf/superbe'),
('4','xf'),
...
INSERT INTO `condition`(`condition_id`, `nom`) VALUES
('1','non spécifié'),
('2','impeccable'),
('3','non utilisé'),
('4','utilisé'),
('5','enveloppe premier jour')
